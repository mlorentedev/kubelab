...
# Tasks - SEC-006-cloud-firewall-for-running-vps
...
- [ ] Branch created from main: `feat/SEC-006-cloud-firewall-for-running-vps`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/SEC-006-cloud-firewall-for-running-vps/features.json`):

```json
[
  {
    "id": "SEC-006-cloud-firewall-for-running-vps-f1",
