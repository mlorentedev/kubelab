...
**All six below are MUST-RESOLVE, so `tasks.md` stays unfrozen — each needs an answer backed by measurement, not by inference.** R1, R2, R3 and R5 are resolved as of 2026-08-12 (evidence in `verification.md`); R4 and R6 remain open.
