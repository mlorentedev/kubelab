...
- [x] [AC1] Role task: `gh auth setup-git` so the same PAT serves git over HTTPS — this is what makes it one credential instead of two. ✓ 2026-08-08
