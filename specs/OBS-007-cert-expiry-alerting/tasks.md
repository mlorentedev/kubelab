...
- [ ] Branch created from main: `feat/OBS-007-cert-expiry-alerting`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/OBS-007-cert-expiry-alerting/features.json`):
