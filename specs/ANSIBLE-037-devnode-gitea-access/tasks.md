...
# Tasks - ANSIBLE-037-devnode-gitea-access
...
- [ ] Branch created from main: `feat/ANSIBLE-037-devnode-gitea-access`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/ANSIBLE-037-devnode-gitea-access/features.json`):

```json
[
  {
    "id": "ANSIBLE-037-devnode-gitea-access-f1",
