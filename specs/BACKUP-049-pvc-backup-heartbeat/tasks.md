...
- [ ] Branch created from main: `feat/BACKUP-049-pvc-backup-heartbeat`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/BACKUP-049-pvc-backup-heartbeat/features.json`):

```json
[
  {
    "id": "BACKUP-049-pvc-backup-heartbeat-f1",
