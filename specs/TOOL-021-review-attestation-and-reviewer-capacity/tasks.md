...
- [ ] Branch created from main: `feat/TOOL-021-review-attestation-and-reviewer-capacity`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/TOOL-021-review-attestation-and-reviewer-capacity/features.json`):

```json
[
  {
    "id": "TOOL-021-review-attestation-and-reviewer-capacity-f1",
