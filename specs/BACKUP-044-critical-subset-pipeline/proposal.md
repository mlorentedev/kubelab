...
- **Migrating the prod PVC CronJob off in-cluster MinIO.** It keeps working. Moving its remaining consumers is what eventually releases #972, and it is BACKUP-046 (#1111)'s work — this spec must simply not add a *new* consumer of `minio:9000`.
