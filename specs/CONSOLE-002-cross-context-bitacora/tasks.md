...
- [ ] Branch created from main: `feat/CONSOLE-002-cross-context-bitacora`
...
Minimal `features.json` skeleton (drop into `kubelab/specs/CONSOLE-002-cross-context-bitacora/features.json`):

```json
[
  {
    "id": "CONSOLE-002-cross-context-bitacora-f1",
