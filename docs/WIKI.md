...
1. [HOW-TO](../HOW-TO/) - Setup básico
2. [CONTRIBUTING](../CONTRIBUTING/) - Convenciones JavaScript/TypeScript
3. [HOW-TO](../HOW-TO/) - Comandos diarios
4. [TROUBLESHOOTING](../TROUBLESHOOTING/) - Problemas comunes web
...
1. [HOW-TO](../HOW-TO/) - Setup básico
2. [CONTRIBUTING](../CONTRIBUTING/) - Convenciones Go
3. [HOW-TO](../HOW-TO/) - Debugging contenedores
4. [CI-CD](../CI-CD/) - Pipeline builds

**Stack**: Go 21, Docker, API REST

### 📝 **Content Creator (Blog)**

1. [HOW-TO](../HOW-TO/) - Levantar blog local
2. [CONTRIBUTING](../CONTRIBUTING/) - Convenciones Ruby/Jekyll
3. [HOW-TO](../HOW-TO/) - Comandos blog
4. [TROUBLESHOOTING](../TROUBLESHOOTING/) - Problemas Jekyll
...
5. [VERSIONING](../VERSIONING/) - Gestión releases
...
2. [TROUBLESHOOTING](../TROUBLESHOOTING/) - Problemas específicos
3. Si necesario: [DEPLOYMENT](../DEPLOYMENT/) - Config servidores
...
4. [CI-CD: Workflows](../CI-CD/) - Si toca CI/CD (10 min)
...
### N-Z
- **Production**: [DEPLOYMENT: Production](../DEPLOYMENT/index.md#entorno-de-producción), [TROUBLESHOOTING: Production](../TROUBLESHOOTING/index.md#problemas-específicos-de-producción)
- **Rollback**: [HOW-TO: Rollback](../HOW-TO/index.md#rollback-de-emergencia), [DEPLOYMENT: Rollback](../DEPLOYMENT/index.md#procedimientos-de-rollback)
- **Security**: [CONTRIBUTING: Security](../CONTRIBUTING/index.md#seguridad), [DEPLOYMENT: Security](../DEPLOYMENT/index.md#endurecimiento-de-seguridad)
