...
| # | Lesson | Date |
|---|---|---|
| 419 | [A secret read from the wrong SOPS store resolves to `''`, so a presence gate on it is open forever](lesson-419-secret-written-to-one-sops-store-read-from-another.md) | 2026-09-02 |
