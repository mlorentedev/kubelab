...
377 lessons, one file each. Newest: 2026-08-23. Open a category for its list.

| Category | # | Scope |
|---|---|---|
| [identity-secrets](identity-secrets/_index.md) | 50 | Authelia, OIDC, SOPS, credentials |
...
| [ansible-provisioning](ansible-provisioning/_index.md) | 46 | Roles, playbooks, IaC, node setup |
| [process-method](process-method/_index.md) | 50 | Specs, reviews, how work is run |
| [edge-tls](edge-tls/_index.md) | 26 | Traefik, TLS, the request path |
| [toolkit-tooling](toolkit-tooling/_index.md) | 29 | Toolkit CLI, Make, Python, tests |
...
at the next free number, front-matter required.
